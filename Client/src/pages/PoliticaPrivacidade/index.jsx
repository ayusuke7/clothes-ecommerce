...
export default function PoliticaPrivacidade() {
  ...
  return (
    <Grid container xs={12} className={classes.container}>
      <Grid item xs={12}>
        <Typography variant="h6">Politicas de Privacidade</Typography>
      </Grid>
      ...
      <Typography variant="h6">SEÇÃO 2 – CONSENTIMENTO</Typography>
      <Typography>
        ...
        momento, entrando em contato conosco em contato@mermaclothes.com.br ou
        nos enviando uma correspondência em: Mermã Clothes
        https://mermaclothes.com.br/
      </Typography>
      <Typography variant="h6">SEÇÃO 3 – DIVULGAÇÃO</Typography>
      <Typography>
      ...
      <Typography variant="h6">SEÇÃO 4 – SERVIÇOS DE TERCEIROS</Typography>
      <Typography>
      ...
      Links Quando você clica em links na nossa loja, eles podem lhe direcionar
      ...
      privacidade deles.
      <Typography variant="h6">SEÇÃO 5 – SEGURANÇA</Typography>
      <Typography>
